...
import course.edu.apps.groupassignmenttwo.R;
...
public class Item implements Serializable {
    ...
    public Item(int imageID, String name, int price, double rating, String manufacturingCountry, String[] availableColors, int quantity, int[] availableSizes, boolean ordered) {
